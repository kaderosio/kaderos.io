...
export const metadata = {
  title: "Die Zukunft der Arbeit in der Schweiz: AI Agents statt Headcount | KaderOS",
  description:
    "Der Schweizer Arbeitsmarkt verändert sich. AI Agents ersetzen nicht Menschen — sie verändern, wie Teams skalieren. Was das für dein Unternehmen bedeutet.",
};
    ...
    <article className="max-w-3xl mx-auto py-16 px-6">
      <div className="mb-10">
        ...
        <h1 className="text-[32px] sm:text-[44px] font-bold tracking-tight mb-4">
          Die Zukunft der Arbeit in der Schweiz: AI Agents statt Headcount
        </h1>
      ...
      <div className="prose prose-lg max-w-none [&_h2]:text-[24px] [&_h2]:font-bold [&_h2]:mt-12 [&_h2]:mb-4 [&_h3]:text-[18px] [&_h3]:font-semibold [&_h3]:mt-8 [&_h3]:mb-3 [&_p]:text-[#6E6E73] [&_p]:leading-relaxed [&_p]:mb-6 [&_li]:text-[#6E6E73] [&_strong]:text-[#1D1D1F]">
        ...
        <h2>Warum Headcount nicht mehr skaliert</h2>
        <p>
          Ein neuer Mitarbeiter in der Schweiz kostet dich:
        </p>
        <ul>
          <li>CHF 3&apos;000–8&apos;000 für Recruiting (Inserate, Headhunter, Zeit)</li>
          <li>42 Tage durchschnittliche Time-to-Hire</li>
          <li>3–6 Monate Onboarding bis zur vollen Produktivität</li>
          <li>CHF 80&apos;000–120&apos;000 Jahreskosten (Lohn, Sozialleistungen, Infrastruktur)</li>
          <li>3 Monate Kündigungsfrist, wenn es nicht passt</li>
        </ul>
        <p>
        ...
        <h2>Das neue Modell: Hybride Teams</h2>
        <p>
        ...
        <h2>Was das für den Arbeitsmarkt bedeutet</h2>
        <p>
          Nein, AI Agents werden nicht alle Jobs ersetzen. Aber sie werden Jobs verändern. Und das ist schon passiert.
        </p>
        <p>
          <strong>Rollen, die sich verändern:</strong> Marketing Manager werden zu Marketing Orchestrators. Sie steuern Agents statt Praktikanten. Office Manager werden zu Operations Architects. Sie designen Workflows statt Mails zu sortieren.
        </p>
        <p>
          <strong>Rollen, die wegfallen:</strong> Reine Dateneingabe-Jobs. Einfache Reporting-Rollen. First-Level-Support ohne Spezialwissen. Routinemässige Recherche-Aufgaben.
        </p>
        <p>
          <strong>Rollen, die entstehen:</strong> AI Team Leads — Menschen, die AI Agents orchestrieren. Prompt Engineers — Menschen, die Agents trainieren und optimieren. AI Ethics Officers — Menschen, die sicherstellen, dass Agents ethisch und compliant handeln.
        </p>
        ...
        <h2>Die drei Wellen der AI-Adoption</h2>

        <h3>Welle 1 (2024–2025): Copilots</h3>
        <p>
        ...
        <h3>Welle 2 (2025–2027): Agents</h3>
        <p>
        ...
        <p>
          <strong>Schritt 1:</strong> Akzeptiere, dass sich die Arbeitswelt verändert. Nicht in 10 Jahren. Jetzt.
        </p>
        <p>
          <strong>Schritt 2:</strong> Identifiziere die operativen Engpässe in deinem Unternehmen. Wo verlierst du die meiste Zeit?
        </p>
        <p>
          <strong>Schritt 3:</strong> Starte mit einem AI Agent. Einem einzigen. Für eine klar definierte Aufgabe.
        </p>
        <p>
          <strong>Schritt 4:</strong> Bilde dich und dein Team weiter. Nicht in AI-Technologie, sondern in AI-Management. Wie orchestriert man Agents? Wie definiert man Rollen? Wie setzt man Guardrails?
        </p>
        <p>
          <strong>Schritt 5:</strong> Skaliere. Wenn der erste Agent funktioniert, bau dein Kader aus.
        </p>
        ...
        <div className="mt-16 p-8 rounded-2xl bg-gradient-to-br from-[#3739C1]/5 to-white border border-[#3739C1]/10">
          <h3 className="text-[20px] font-bold text-[#1D1D1F] mb-3">
            Bau dein Kader der Zukunft
          </h3>
          <p className="text-[15px] text-[#6E6E73] mb-5">
            KaderOS orchestriert hybride Teams aus Menschen und AI Agents.
            Gebaut für Schweizer Unternehmen, die vorausgehen.
          </p>
          <Link
            href="/landing"
