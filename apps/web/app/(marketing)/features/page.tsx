  ...
  return (
    <div className="py-20 px-6">
      ...
      <div className="max-w-2xl mx-auto text-center mt-24">
        ...
        <a href="/#cta" className="inline-flex items-center gap-2 px-8 py-3.5 bg-[#000088] text-white text-[14px] font-semibold rounded-xl hover:shadow-lg hover:bg-[#000066] transition-all">
