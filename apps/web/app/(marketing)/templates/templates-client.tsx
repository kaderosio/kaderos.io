  ...
  return (
    <div className="py-20 px-6">
          ...
          <div key={t.name} className="rounded-2xl border border-[#E5E5EA] bg-white overflow-hidden hover:shadow-xl transition-shadow">
            <div className="p-8">
              <div className="flex items-start gap-6">
                ...
                <a href="/signup" className="shrink-0 px-5 py-2.5 bg-[#000088] text-white text-[13px] font-semibold rounded-xl hover:bg-[#000066] hover:shadow-lg transition-all flex items-center gap-2">
      ...
      <div className="max-w-3xl mx-auto text-center mt-16 p-10 rounded-2xl border-2 border-dashed border-[#E5E5EA]">
        ...
        <a href="/#cta" className="inline-flex items-center gap-2 px-6 py-3 bg-[#F5F5F7] text-[#1D1D1F] text-[13px] font-semibold rounded-xl border border-[#E5E5EA] hover:border-[#000088] hover:text-[#000088] transition-all">
