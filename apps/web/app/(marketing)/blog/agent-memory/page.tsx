...
export const metadata = {
  title: "Agent Memory: Warum dein AI-Team ein Gehirn braucht | KaderOS",
  description:
    "Dein AI-Tool vergisst alles nach jeder Session. KaderOS gibt deinem Kader ein persistentes Gedächtnis — lokal, autonom, ohne API-Kosten. Swiss Made.",
};
  ...
  return (
    <article className="max-w-3xl mx-auto py-16 px-6">
      ...
      <div className="prose prose-lg max-w-none [&_h2]:text-[24px] [&_h2]:font-bold [&_h2]:mt-12 [&_h2]:mb-4 [&_h3]:text-[18px] [&_h3]:font-semibold [&_h3]:mt-8 [&_h3]:mb-3 [&_p]:text-[#6E6E73] [&_p]:leading-relaxed [&_p]:mb-6 [&_li]:text-[#6E6E73] [&_strong]:text-[#1D1D1F]">
        ...
        <h2>Das Problem: Stateless AI ist nutzlos für echte Arbeit</h2>
        <p>
        ...
        <h2>Die 7 Schichten von Agent Memory</h2>
        <p>
        ...
        <h3>1. Perception Gate — Was ist wichtig?</h3>
        <p>
        ...
        <h3>2. Working Memory — Fokus auf das Aktuelle</h3>
        <p>
        ...
        <h3>3. Episodisches Gedächtnis — Was ist passiert?</h3>
        <p>
        ...
        <h3>4. Knowledge Graph — Wer gehört zu wem?</h3>
        <p>
        ...
        <h3>5. Prozedurales Gedächtnis — Lernen durch Wiederholung</h3>
        <p>
        ...
        <h3>6. Predictive Engine — Was kommt als Nächstes?</h3>
        <p>
        ...
        <h3>7. Dream Cycle — Nachts wird verdichtet</h3>
        <p>
        ...
        <h2>Konkretes Beispiel: Du sagst &quot;Müller&quot;</h2>
        <p>
          <strong>Ohne Agent Memory:</strong>
        </p>
        <p className="italic border-l-4 border-[#E5E5EA] pl-4">
          &quot;Wer ist Müller? Kannst du mir mehr Kontext geben?&quot;
        </p>
        <p>
          <strong>Mit KaderOS Agent Memory:</strong>
        </p>
        <p className="italic border-l-4 border-[#000088]/20 pl-4">
        ...
        <h2>Warum kein LLM dafür nötig ist</h2>
        <p>
          Agent Memory basiert nicht auf grossen Sprachmodellen. Es ist reine Mathematik. Vektoren, Graphen, Pattern Matching.
        </p>
        <p>
          Die Technologie dahinter: <strong>pgvector</strong> für Vektor-Suche direkt in PostgreSQL. <strong>spaCy</strong> für Textverständnis und Entity-Erkennung. Beides lokal. Beides Open Source.
        </p>
        <ul>
          <li><strong>Keine API-Kosten</strong> pro Abfrage. Dein Gedächtnis läuft auf deiner Infrastruktur.</li>
          <li><strong>Keine Daten, die rausgehen.</strong> Nichts wird an OpenAI, Google oder sonst wen gesendet.</li>
          <li><strong>Volle Kontrolle.</strong> Du entscheidest, was gespeichert wird und was nicht.</li>
        </ul>

        <h2>Der Vergleich: Wer erinnert sich?</h2>
        <div className="overflow-x-auto my-8">
          <table className="min-w-full text-[14px] border-collapse">
            <thead>
              <tr className="border-b border-[#E5E5E7]">
                <th className="text-left py-3 pr-4 font-semibold text-[#1D1D1F]"></th>
                <th className="text-left py-3 pr-4 font-semibold text-[#1D1D1F]">ChatGPT</th>
            ...
            <tbody className="[&_td]:py-2 [&_td]:pr-4 [&_td]:text-[#6E6E73] [&_tr]:border-b [&_tr]:border-[#F0F0F0]">
              <tr><td><strong>Session-Memory</strong></td><td>Begrenzt</td><td>Nein</td><td>Nein</td><td>Ja</td></tr>
              <tr><td><strong>Persistentes Gedächtnis</strong></td><td>Nein</td><td>Nein</td><td>Nein</td><td>Ja, 7 Schichten</td></tr>
              <tr><td><strong>Knowledge Graph</strong></td><td>Nein</td><td>Nein</td><td>Nein</td><td>Automatisch</td></tr>
              <tr><td><strong>Lokale Daten</strong></td><td>Nein</td><td>Teilweise</td><td>Teilweise</td><td>100% lokal</td></tr>
              <tr><td><strong>Lernt über Zeit</strong></td><td>Nein</td><td>Nein</td><td>Nein</td><td>Ja, autonom</td></tr>
              <tr><td><strong>API-Kosten für Memory</strong></td><td>Ja</td><td>Ja</td><td>Ja</td><td>CHF 0</td></tr>
            </tbody>
          </table>
        </div>

        <h2>Was das für dein Unternehmen bedeutet</h2>
        <p>
