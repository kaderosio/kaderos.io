...
export const metadata = {
  title: "Bexio + AI: Buchhaltung automatisieren | KaderOS",
  description:
    "80'000 Schweizer KMUs nutzen Bexio. Fast keines nutzt AI dafür. So automatisierst du Rechnungen, Mahnwesen und Cashflow-Vorhersagen mit KaderOS.",
};
  ...
  return (
    <article className="max-w-3xl mx-auto py-16 px-6">
      ...
      <div className="prose prose-lg max-w-none [&_h2]:text-[24px] [&_h2]:font-bold [&_h2]:mt-12 [&_h2]:mb-4 [&_h3]:text-[18px] [&_h3]:font-semibold [&_h3]:mt-8 [&_h3]:mb-3 [&_p]:text-[#6E6E73] [&_p]:leading-relaxed [&_p]:mb-6 [&_li]:text-[#6E6E73] [&_strong]:text-[#1D1D1F]">
        ...
        <p>
          Bexio ist gut. Für das, was es ist. Eine Buchhaltungssoftware. Du erstellst Rechnungen. Du verbuchst Ausgaben. Du verwaltest Kontakte. Du exportierst für den Treuhänder.
        </p>
        <p>
          Aber Bexio ist reaktiv. Du gibst Befehle. Bexio führt aus. Ende.
        </p>
        <p>
          Was Bexio nicht macht:
        </p>
        <ul>
          ...
          <li><strong>Kein Kontext.</strong> Bexio weiss nicht, dass Kunde X immer 14 Tage zu spät zahlt.</li>
        </ul>
        ...
        <p>
          &quot;Können wir uns diesen neuen Mitarbeiter leisten?&quot; — AI rechnet nicht nur mit dem heutigen Kontostand. Sondern mit erwarteten Zahlungseingängen, wiederkehrenden Kosten, saisonalen Schwankungen und offenen Offerten.
        </p>
        <p>
        ...
        <p>
          Kunde hat vor 6 Monaten angefragt, aber nie bestellt? AI erinnert sich. Und schlägt dir ein Follow-up vor. Mit Kontext: Was wurde besprochen? Was war der letzte Kontaktpunkt?
        </p>
        ...
        <p>
          So wird es funktionieren: Dein <strong>Finanz-Kader</strong> in KaderOS verbindet sich mit deiner Bexio-Instanz. Über die offizielle Bexio API. Lokal. Deine Daten bleiben bei dir.
        </p>
        <p>
          Was dein Finanz-Kader dann kann:
        </p>
        <ul>
          ...
          <li><strong>Warnen bei Budgetüberschreitung.</strong> Projekt läuft über 80% des Budgets? Dein Kader meldet sich. Sofort.</li>
        ...
        <p>
          <strong>Swiss Made.</strong> Deine Daten bleiben in der Schweiz. nDSG-konform.
        </p>

        <h2>Was du heute schon machen kannst</h2>
        <p>
          Die direkte Bexio-API-Anbindung kommt. Bis dahin gibt es einen Workaround:
        </p>
        <ul>
          ...
          <li><strong>Fragen stellen.</strong> &quot;Welche Rechnungen sind seit mehr als 30 Tagen offen?&quot; — &quot;Wie sieht mein Cashflow für die nächsten 8 Wochen aus?&quot;</li>
          <li><strong>Handeln.</strong> Basierend auf den Antworten deines Kaders.</li>
        </ul>
        <p>
          Ja, der Export ist manuell. Aber du bekommst trotzdem Analysen, die du von Bexio allein nie kriegst. In Sekunden statt Stunden.
        </p>

        <h2>Warum das für dein KMU relevant ist</h2>
        <p>
          Schweizer KMUs verbrennen im Schnitt 8-12 Stunden pro Monat mit Buchhaltungs-Admin. Das sind 100+ Stunden pro Jahr. Für Arbeit, die kein Geld bringt.
        </p>
        <p>
        ...
        <div className="mt-16 p-8 rounded-2xl bg-gradient-to-br from-[#000088]/5 to-white border border-[#000088]/10">
          ...
          <p className="text-[15px] text-[#6E6E73] mb-5">
            Die Warteliste ist offen. Sichere dir deinen Platz.
          </p>
          <Link
            href="/"
