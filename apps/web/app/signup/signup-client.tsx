    ...
    return (
      ...
      >
        <div style={{ width: "100%", maxWidth: 420, textAlign: "center" }}>
          ...
          <h1 style={{ fontSize: 28, fontWeight: 800, color: "#1D1D1F", marginBottom: 8 }}>
            Check deine E-Mail
          </h1>
    ...
    >
      <div style={{ width: "100%", maxWidth: 420, textAlign: "center" }}>
        ...
        <p style={{ fontSize: 16, color: "#6E6E73", marginBottom: 32 }}>
          Erstelle deinen Account. Kostenlos starten.
        </p>
        ...
        <p style={{ marginTop: 16, fontSize: 12, color: "#9CA3AF", lineHeight: 1.5 }}>
          Mit der Registrierung akzeptierst du die{" "}
          <Link href="/agb" style={{ color: "#6E6E73" }}>AGB</Link> und{" "}
          <Link href="/datenschutz" style={{ color: "#6E6E73" }}>Datenschutzerklärung</Link>.
        </p>
      </div>
    </div>
  );
