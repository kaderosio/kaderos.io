...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/entscheidungen", label: "Entscheidungen", icon: Scale },
  { href: "/dashboard/automation", label: "Automation", icon: Zap },
  { href: "/dashboard/workflows", label: "Workflows", icon: GitBranch },
  { href: "/dashboard/wissensbasis", label: "Wissensbasis", icon: BookOpen },
  { href: "/dashboard/gedaechtnis", label: "Ged\u00e4chtnis", icon: Brain },
